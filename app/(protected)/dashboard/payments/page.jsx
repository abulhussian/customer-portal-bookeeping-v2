              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 text-white w-full">
                    ...
                    <h3 className="text-xs sm:text-sm font-medium text-white uppercase tracking-wider">{config.label}</h3>
                  </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentRows.map((payment, index) => (
                      <motion.tr
                        ...
                        className={`h-[61px] bg-white rounded-[8px] opacity-100 transition-all cursor-pointer ${selectedRowId === payment.id
