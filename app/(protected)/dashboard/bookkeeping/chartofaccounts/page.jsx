...
//     <div className="space-y-3 p-2 sm:p-6 max-w-7xl mx-auto overflow-y-auto max-h-[calc(100vh)] pb-24 sm:pb-8 mt-3">
...
export default function ChartOfAccounts() {
  ...
  const handleUpdateModal = (account) => {
    setSelectedRowId(account.id); // 👈 ADD THIS LINE
    setIsUpdateModalOpen(true);
    setIsViewData(account);
  };
  ...
  return (
    <motion.div className="flex flex-col min-h-screen">
      <div className="space-y-3 p-2 sm:p-6 max-w-7xl mx-auto w-full overflow-hidden flex flex-col flex-1">
        {/* Header Section */}
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-gray-900">Chart of Accounts</h2>
        ...
        <div className="bg-white p-1 sm:p-1 sm:pl-2">
          <div className="flex items-center justify-between gap-3 sm:gap-4">
            <div className="flex flex-1 items-center gap-3">
              ...
              {/* 🔍 Search Section - Properly Aligned */}
              <div className="flex-1 flex justify-end">
                {!isSearchActive ? (
                  // 🔍 Search Button State
                  <button
                    onClick={() => setIsSearchActive(true)}
                    className="flex items-center justify-center w-8 h-8 sm:w-[42px] sm:h-[42px] cursor-pointer hover:opacity-80 transition"
                  >
                    <img
                      src="/searchsvg-1.svg"
                      alt="search"
                  ...
                  // 🔍 Active Search Input State
                  <div className="relative w-full max-w-md">
                    <img
                      src="/search-icon-2.svg"
                      alt="search-icon"
                      className="w-4 h-4 sm:w-[17px] sm:h-[17px] absolute left-3 top-1/2 -translate-y-1/2"
                    />
                    <input
                      type="text"
                      placeholder="Search accounts by ID, name, type, or category..."
              ...
              {!isSearchActive && (
                <div className="flex gap-2 sm:gap-3">
                  <button
                    onClick={() => setIsFilterModalOpen(!isFilterModalOpen)}
                    className="flex items-center justify-center gap-2 w-[123px] h-[42px] bg-[#F5F5FA] border border-[#E4E3F1] rounded-[8px] transition-colors hover:bg-gray-200 px-4 py-2"
                  >
                    <img
                      src="/filter-icon.png"
                      alt="filter-icon"
                  ...
                  <button
                    onClick={() => setIsAddModalOpen(true)}
                    className="px-2 text-sm py-1 bg-[linear-gradient(257deg,_#5EA1F8_0%,_#4486D9_100%)] rounded-[10px_10px_10px_0px] opacity-100 flex items-center justify-center text-white gap-2  "
                  >
                    <Plus className="w-4 h-4" /> Add Account
                  </button>
                </div>
        ...
        <div className="flex-1 flex flex-col bg-white shadow rounded-lg overflow-hidden min-h-0">
          <div className="flex-1 overflow-hidden">
            {currentItems.length === 0 ? (
              <div className="p-8 sm:p-12 text-center h-full flex items-center justify-center">
                <div>
                  <div className="text-4xl sm:text-6xl mb-4">📝</div>
                  <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">No Accounts Found</h3>
                  <p className="text-gray-600 text-sm sm:text-base">
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 overflow-auto">
                  <table className="w-full min-w-[800px] divide-y divide-gray-200 text-center">
                        ...
                        >
                          ...
                          <td className="px-3 sm:px-4 py-3 text-left whitespace-nowrap min-w-[100px]">
                            <div className="flex justify-start items-center">
                              ...
                              <span className="text-xs sm:text-sm text-gray-900">
                                {account.documents === null ? 0 : account.documents.length} files
                              </span>
                            </div>
                          </td>
                          ...
                          <td className="px-3 sm:px-4 py-3 text-left whitespace-nowrap min-w-[100px]">
                            <div className="flex justify-center items-center space-x-1 sm:space-x-2">
                              ...
                              <button 
                                className="md:hidden text-gray-600 hover:text-gray-700 transition-colors"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <MoreVertical className="w-3 h-3 sm:w-4 sm:h-4" />
                              </button>
                ...
                <div className="h-auto sm:h-[55px] w-full bg-[#F5F5FA] rounded-[10px] opacity-100 px-3 sm:px-4 py-3 flex items-center justify-between border-t border-gray-200 sticky bottom-0 z-10">
                  <div className="flex flex-col sm:flex-row sm:flex-1 sm:items-center sm:justify-between gap-3 sm:gap-0 w-full">
                    <div className="text-center sm:text-left">
                      <p className="text-xs sm:text-sm text-gray-700">
                        Showing <span className="font-medium">{(currentPage - 1) * itemsPerPage + 1}</span> to{' '}
      ...
      {/* Filter Modal - FIXED CLOSE BUTTON POSITION */}
      {isFilterModalOpen && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-2 relative">
            {/* Fixed Close Button - Now properly inside modal */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-900">Filters</h3>
              <button
                onClick={() => setIsFilterModalOpen(false)}
                className="flex items-center justify-center w-8 h-8 bg-[#F5F5FA] rounded-full hover:bg-gray-200 transition-colors"
              >
            ...
            {/* Apply Filters Button - Fixed for mobile visibility */}
            <div className="flex justify-center items-center w-full p-6 pt-0">
              <button
                onClick={applyFilters}
                className="w-full max-w-[370px] h-[50px] text-white font-medium text-[14px] rounded-[10px] opacity-100 
                  bg-gradient-to-l from-[#66A4E4] to-[#575DD5] 
