...
export default function Documents() {
  ...
  return (
    <div className="space-y-3 p-6 max-h-[calc(100vh-50px)] overflow-y-auto">
      ...
      <div className="flex gap-5 mt-4">
        {[
          { title: "Total Files", count: 156, icon: <FileText className="h-6 w-6 text-white" />, bg: "/Rectangle145138.svg", rounded: "rounded-[40px_6px_6px_6px]", borderColor: "#7285D5", iconBg: "#9A6EEF" },
          { title: "Invoices", count: 45, icon: <File className="h-6 w-6 text-white" />, bg: "/Rectangle145211orange.svg", rounded: "rounded-[6px]", borderColor: "#DD7949", iconBg: "#E86118" },
          { title: "Statements", count: 32, icon: <FileText className="h-6 w-6 text-white" />, bg: "/Rectangle145235blue.svg", rounded: "rounded-[6px]", borderColor: "#7285D5", iconBg: "#4C56CC" },
          { title: "Receipts", count: 79, icon: <FileText className="h-6 w-6 text-white" />, bg: "/Rectangle45212.svg", rounded: "rounded-[6px_6px_40px_6px]", borderColor: "#3CB0A5", iconBg: "#229187" },
        ].map((card, index) => (
          <div
            key={index}
            className={`relative w-[234px] h-[142px] ${card.rounded} 
                 bg-cover bg-no-repeat hover:shadow-lg transition-shadow cursor-pointer p-4`}
            style={{ backgroundImage: `url(${card.bg})`, border: `1px solid ${card.borderColor}` }}
          >
            <div className="flex flex-col justify-between h-full">
              <div className="flex items-center gap-4 pb-2">
                <div
                  className="p-2 rounded-full w-[39px] h-[39px] flex items-center justify-center"
